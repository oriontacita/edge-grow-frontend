    ...
    <>
      ...
      >
        <div className="mb-10 px-2 flex items-center gap-3">
          ...
          <div>
            <p className="font-headline-md text-primary font-extrabold leading-none">PITA</p>
        ...
        <nav className="flex-1 space-y-1">
          ...
          <div
            className="flex items-center gap-3 px-4 py-3 rounded-lg font-body-md text-on-surface-variant/50 cursor-not-allowed select-none"
            title="Segera hadir"
          >
        ...
        <div className="mt-auto pt-6 border-t border-outline-variant flex items-center gap-3 px-2">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="text-xs text-on-surface-variant truncate">Posyandu</p>
          </div>
          <button
            aria-label="Logout"
